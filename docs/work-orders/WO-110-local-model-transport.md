# WO-110 — Local-model transport: a third `WorkOrderTransport` over a local inference endpoint joins the actor catalog for the inspection profile, written from WO-027's probe and a fresh availability row (v0.36.0)

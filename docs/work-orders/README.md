...
[WO-029 — Pinned artifact identity: bind an equipped compilation to its consuming decisions (version assigned at activation)](WO-029-pinned-artifact-identity.md)

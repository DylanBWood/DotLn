...
[WO-009 — Real disposable worker (application version assigned at activation)](WO-009-real-disposable-worker.md)
...
[WO-010 — Independent verification (application version assigned at activation)](WO-010-independent-verification.md)

- State: draft.
- Application target: unassigned.
- Dependency reference check (conservative): blocked on WO-009.
- References: WO-009: not control-closed.
- Verification: none recorded.
- Final review: none recorded.
- Release: none recorded.
- Model: any capable model.
...
[WO-011 — Feedback compiler v1 (ten units; application version assigned at activation)](WO-011-feedback-compiler.md)

- State: draft.
- Application target: malformed.
- Dependency reference check (conservative): blocked on WO-009, WO-010.
- References: WO-004: satisfied (closed); WO-009: not control-closed; WO-010: not control-closed.
- Verification: none recorded.
- Final review: none recorded.
- Release: none recorded.
- Model: any capable model.
...
[WO-108 — Mutation probe of the existing kernel and skeleton evidence suites (version assigned at activation)](WO-108-mutation-probe.md)
...
- State: closed.
- Application target: v0.3.3.
- Dependency reference check (conservative): blocked on WO-001, WO-009.
- References: WO-001: not control-closed; WO-004: satisfied (closed); WO-008: satisfied (closed); WO-009: not control-closed.
...
- Dependency reference check (conservative): blocked on WO-009.
- References: WO-008: satisfied (closed); WO-009: not control-closed; WO-016: satisfied (closed); WO-023: satisfied (closed); WO-101: satisfied (closed).
...
- State: closed.
- Application target: v0.2.0.
- Dependency reference check (conservative): blocked on WO-011.
- References: WO-004: satisfied (closed); WO-005: satisfied (closed); WO-011: not control-closed.
...
Local annotated release tags used: `v0.2.0`, `v0.2.1`, `v0.2.2`, `v0.2.3`, `v0.3.0`, `v0.3.1`, `v0.3.2`, `v0.3.3`, `v0.3.4`, `v0.3.5`, `v0.3.6`, `v0.4.0`, `v0.4.1`, `v0.5.0`, `v0.5.1`, `v0.5.2`, `v0.6.0`, `v0.7.0`, `v0.8.0`.

...
[WO-149 — Codex sessions begin: a Codex-launched dispatch records its harness session before any usage is measured, so a Codex verification or review receipt carries real token counters instead of &#96;unknown; cause no-session&#96; (version assigned at activation)](WO-149-codex-sessions-begin.md)

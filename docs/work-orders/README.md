...
- [x] [WO-154] — Evidence editions keyed by behavior and recorded by reference · **final-reviewed**
- [x] [WO-155] — Single-source floor and a cold-start trend · **final-reviewed**
- [x] [WO-156] — plan check in the sub-second band · **final-reviewed**
- [x] [WO-111] — The unattended hour · **final-reviewed**
- [x] [WO-114] — Runtime status projection · **final-reviewed**

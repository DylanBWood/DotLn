...
[WO-126 — Process debt: the lifecycle machinery costs more than the code it guards; one order demotes the theater, automates the closeout, and installs the meter (version assigned at activation)](WO-126-process-debt.md)

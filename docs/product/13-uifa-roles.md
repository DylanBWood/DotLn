...
| Devops       | `resume`, `worktree`, `release`, `work-orders`, publication/evidence gates; staged WO-009 disposable inspection workers, leases and `dotln status` | Senses (WO-022); general worker profiles and recurring-procedure automation beyond the bounded inspection host                               |

...
| Devops       | `resume`, `worktree`, `release`, `work-orders`, publication/evidence gates; disposable inspection workers, leases, `dotln status`, and WO-022 metadata sense profiles | General worker profiles and recurring-procedure automation beyond the bounded inspection host                                                |

...
Operator corrections raised during WO-003 verification (raw: `docs/intake/notes/wo-003-expanded-ideation-2026-08-31.md`, dumps 019–021). Recorded here rather than applied silently, so the earlier misreading stays visible.

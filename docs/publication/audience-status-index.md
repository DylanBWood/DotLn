...
| [Beacon codebook v3 — weak keyed provenance](../product/02-domain-model.md#beacon-codebook-v3--weak-keyed-provenance) | everyday-ai-user, software-engineer | implemented |
...
| [Candidate — DotLn-owned authority with minimal native harness restrictions](../product/03-architecture.md#candidate--dotln-owned-authority-with-minimal-native-harness-restrictions) | everyday-ai-user, software-engineer | planned |
...
| [Executor supports: Adjacent Repair and Decision Receipts](../product/05-pattern-library.md#executor-supports-adjacent-repair-and-decision-receipts)           | everyday-ai-user, software-engineer | implemented |
...
| [Candidate — whole or split work orders under one umbrella](../product/06-roadmap.md#candidate--whole-or-split-work-orders-under-one-umbrella)                                                                 | everyday-ai-user, software-engineer | vision      |
...
| [Candidate — local-model usefulness experiments](../product/06-roadmap.md#candidate--local-model-usefulness-experiments) | everyday-ai-user, software-engineer | planned |

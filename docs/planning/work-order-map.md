...
1. **Append-lock recovery wedge after a kill.** A SIGKILL inside the
   ...
   order. Reopen: the next planning pass, or a second wedged store.
...
| [WO-090](../work-orders/WO-090-shorter-cold-start.md)                 | documentation — the guide reduced to the operating contract with the directed-load total measured lower                                                                                                                                                                                        | deferred (waivable) until WO-053; assign version at activation (patch) Moved 2026-09-19: lane pair with WO-071 in the slot WO-138 cannot use; after WO-142, WO-140 and WO-079 write product 07. | documentation implementer, then independent verifier                                                      | the directed-load measurement                                                                                                                                         | product 07, `docs/AI-HARNESS-SECURITY.md`, the playbook                                                                                                                                                          |

// Origin: {"ids":["contributor.executor","contributor.planner","contributor.refuter","contributor.release-close","contributor.reviewer","contributor.verifier","no-attribution"],"loadoutId":"contributor","semanticHash":"fnv1a64:41aa929faf455544"}
let input;
try {
...
await runHarnessHook({
  ...
  "policy": {
    ...
    "policyHash": "fnv1a64:5d9b1f41008c1374"
  },

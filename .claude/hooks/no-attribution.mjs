// Origin: {"ids":["contributor.executor","contributor.planner","contributor.refuter","contributor.release-close","contributor.reviewer","contributor.verifier","no-attribution"],"loadoutId":"contributor","semanticHash":"fnv1a64:c020dc62ca7cc8eb"}
let input, control;
try {
...
await runHarnessHook({
  ...
  "policy": {
    ...
    "policyHash": "fnv1a64:fe48f40942d12a43"
  },

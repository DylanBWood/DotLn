// Origin: {"ids":["contributor.executor","contributor.planner","contributor.refuter","contributor.release-close","contributor.reviewer","contributor.verifier"],"loadoutId":"contributor","semanticHash":"fnv1a64:4d9dc4e490824232"}
try {
const { feedbackBoundary } = await import("../../.runtime/harness/eca086f28b683ecb/packages/skeleton/dist/src/feedback-boundary.js");
const { runHarnessHook } = await import("../../.runtime/harness/eca086f28b683ecb/packages/skeleton/dist/src/harness-host.js");
await runHarnessHook({
  "compilerPackageVersion": "0.9.1",
  "runtime": {
    "skeletonVersion": "0.15.8",
    ...
    "snapshot": ".runtime/harness/eca086f28b683ecb"
  },

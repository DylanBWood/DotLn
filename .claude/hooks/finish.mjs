...
const { feedbackBoundary } = await import("../../.runtime/harness/a2fc955825e0b962/packages/skeleton/dist/src/feedback-boundary.js");
const { runHarnessHook } = await import("../../.runtime/harness/a2fc955825e0b962/packages/skeleton/dist/src/harness-host.js");
await runHarnessHook({
  ...
  "runtime": {
    ...
    "snapshot": ".runtime/harness/a2fc955825e0b962"
  },
  "event": "Stop",
  "tools": {
    "Read": "read",
...
const snapshot = ".runtime/harness/a2fc955825e0b962";

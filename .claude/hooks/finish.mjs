...
const { runHarnessHook } = await import("../../.runtime/harness/0f7b7a128b5726e4/packages/skeleton/dist/src/harness-host.js");
...
const snapshot = ".runtime/harness/0f7b7a128b5726e4";

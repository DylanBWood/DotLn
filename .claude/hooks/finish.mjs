...
const { runHarnessHook } = await import("../../.runtime/harness/fa15c8d28a80773f/packages/skeleton/dist/src/harness-host.js");
...
const snapshot = ".runtime/harness/fa15c8d28a80773f";

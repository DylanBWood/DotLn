...
const { runHarnessHook } = await import("../../.runtime/harness/964e68064c7333e4/packages/skeleton/dist/src/harness-host.js");
...
const snapshot = ".runtime/harness/964e68064c7333e4";

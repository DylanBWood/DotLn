// Origin: {"ids":["anti-oscillation","bounded-boy-scout-cleanup","concurrent-work-requires-worktrees","contributor.executor","contributor.planner","contributor.refuter","contributor.release-close","contributor.reviewer","contributor.verifier","correctness-over-sycophancy","fail-conservative-correction","no-attribution","no-lint-type-disables-as-fixes","no-partial-completion","read-your-own-output","verify-app-before-done"],"loadoutId":"contributor","semanticHash":"fnv1a64:41aa929faf455544"}
let input;
try {
...
const { runHarnessHook } = await import("../../.runtime/harness/c07fee7fdc83d9ee/packages/skeleton/dist/src/harness-host.js");
await runHarnessHook({
  ...
  "policy": {
    ...
    "policyHash": "fnv1a64:824b901d8ad3e32c"
  }
...
const snapshot = ".runtime/harness/c07fee7fdc83d9ee";

...
const { runHarnessHook } = await import("../../.runtime/harness/2bb2e9829a58dfa1/packages/skeleton/dist/src/harness-host.js");
...
const snapshot = ".runtime/harness/2bb2e9829a58dfa1";

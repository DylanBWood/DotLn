// Origin: {"ids":["anti-oscillation","bounded-boy-scout-cleanup","concurrent-work-requires-worktrees","contributor.executor","contributor.planner","contributor.refuter","contributor.release-close","contributor.reviewer","contributor.verifier","correctness-over-sycophancy","fail-conservative-correction","no-attribution","no-lint-type-disables-as-fixes","no-partial-completion","read-your-own-output","verify-app-before-done"],"loadoutId":"contributor","semanticHash":"fnv1a64:c020dc62ca7cc8eb"}
let input, control;
try {
...
const { feedbackBoundary } = await import("../../.runtime/harness/41853b351d9f5602/packages/skeleton/dist/src/feedback-boundary.js");
const { runHarnessHook } = await import("../../.runtime/harness/41853b351d9f5602/packages/skeleton/dist/src/harness-host.js");
await runHarnessHook({
  "compilerPackageVersion": "0.19.0",
  "runtime": {
    ...
    "files": [
      {
        ...
        "hash": "fnv1a64:5625526922dbf369"
      },
      {
        "path": "packages/compiler/dist/src/harness.js",
        "hash": "fnv1a64:1475ef58e02b189c"
      },
      {
    ...
    "snapshot": ".runtime/harness/41853b351d9f5602"
  },
  "event": "Stop",
  "tools": {
    "Read": "read",
  ...
  "policy": {
    ...
    "policyHash": "fnv1a64:3ad2a3b06260b383"
  }
...
const snapshot = ".runtime/harness/41853b351d9f5602";

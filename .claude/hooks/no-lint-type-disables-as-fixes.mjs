// Origin: {"ids":["contributor.executor","contributor.planner","contributor.refuter","contributor.release-close","contributor.reviewer","contributor.verifier","no-lint-type-disables-as-fixes"],"loadoutId":"contributor","semanticHash":"fnv1a64:c020dc62ca7cc8eb"}
let input, control;
try {
...
await runHarnessHook({
  ...
  "policy": {
    ...
    "policyHash": "fnv1a64:8ec0424259da548a"
  },

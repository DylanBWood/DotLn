// Origin: {"ids":["contributor.executor","contributor.planner","contributor.refuter","contributor.release-close","contributor.reviewer","contributor.verifier","no-lint-type-disables-as-fixes"],"loadoutId":"contributor","semanticHash":"fnv1a64:ce8357c584828acc"}
let input;
try {
...
await runHarnessHook({
  ...
  "policy": {
    ...
    "policyHash": "fnv1a64:88119076340f1190"
  },

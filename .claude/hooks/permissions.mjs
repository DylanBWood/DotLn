...
const { runHarnessHook } = await import("../../.runtime/harness/bb9522b84d7a517d/packages/skeleton/dist/src/harness-host.js");
...
const snapshot = ".runtime/harness/bb9522b84d7a517d";

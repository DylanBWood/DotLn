...
const { runHarnessHook } = await import("../../.runtime/harness/dd42b09cdbe9b43e/packages/skeleton/dist/src/harness-host.js");
...
const snapshot = ".runtime/harness/dd42b09cdbe9b43e";

...
const { runHarnessHook } = await import("../../.runtime/harness/44b1e7b00bdb62a5/packages/skeleton/dist/src/harness-host.js");
...
const snapshot = ".runtime/harness/44b1e7b00bdb62a5";

...
const { runHarnessHook } = await import("../../.runtime/harness/4f9815f782d52c03/packages/skeleton/dist/src/harness-host.js");
...
const snapshot = ".runtime/harness/4f9815f782d52c03";

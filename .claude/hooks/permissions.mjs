...
const { runHarnessHook } = await import("../../.runtime/harness/0ccad9b7d8829ee7/packages/skeleton/dist/src/harness-host.js");
...
const snapshot = ".runtime/harness/0ccad9b7d8829ee7";

...
const { feedbackBoundary } = await import("../../.runtime/harness/df7e78a00dcbddb4/packages/skeleton/dist/src/feedback-boundary.js");
const { runHarnessHook } = await import("../../.runtime/harness/df7e78a00dcbddb4/packages/skeleton/dist/src/harness-host.js");
await runHarnessHook({
  ...
  "runtime": {
    ...
    "snapshot": ".runtime/harness/df7e78a00dcbddb4"
  },
  "event": "PreToolUse",
  "tools": {
    "Read": "read",
...
const snapshot = ".runtime/harness/df7e78a00dcbddb4";

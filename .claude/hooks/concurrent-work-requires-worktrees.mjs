...
const { feedbackBoundary } = await import("../../.runtime/harness/779b76b9ce51775a/packages/skeleton/dist/src/feedback-boundary.js");
const { runHarnessHook } = await import("../../.runtime/harness/779b76b9ce51775a/packages/skeleton/dist/src/harness-host.js");
await runHarnessHook({
  "compilerPackageVersion": "0.16.0",
  "runtime": {
    "skeletonVersion": "0.30.0",
    ...
    "snapshot": ".runtime/harness/779b76b9ce51775a"
  },
  "event": "PreToolUse",
  "tools": {
    "Read": "read",
  ...
  "policy": {
    ...
    "policyHash": "fnv1a64:521764b9e1a8a9d5"
  },
...
const snapshot = ".runtime/harness/779b76b9ce51775a";

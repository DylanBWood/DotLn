// Origin: {"ids":["concurrent-work-requires-worktrees","contributor.executor","contributor.planner","contributor.refuter","contributor.release-close","contributor.reviewer","contributor.verifier"],"loadoutId":"contributor","semanticHash":"fnv1a64:3fda088a97df0f55"}
let input, control;
try {
...
const { runHarnessHook } = await import("../../.runtime/harness/f7ed9b15172f8c30/packages/skeleton/dist/src/harness-host.js");
await runHarnessHook({
  ...
  "policy": {
    ...
    "policyHash": "fnv1a64:1e7fc236da802323"
  },
...
const snapshot = ".runtime/harness/f7ed9b15172f8c30";

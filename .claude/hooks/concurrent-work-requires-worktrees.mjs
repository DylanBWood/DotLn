// Origin: {"ids":["concurrent-work-requires-worktrees","contributor.executor","contributor.planner","contributor.refuter","contributor.release-close","contributor.reviewer","contributor.verifier"],"loadoutId":"contributor","semanticHash":"fnv1a64:55b87ceca766bc72"}
let input;
try {
...
const { feedbackBoundary } = await import("../../.runtime/harness/3618ed978eed1706/packages/skeleton/dist/src/feedback-boundary.js");
const { runHarnessHook } = await import("../../.runtime/harness/3618ed978eed1706/packages/skeleton/dist/src/harness-host.js");
await runHarnessHook({
  "compilerPackageVersion": "0.17.0",
  "runtime": {
    "skeletonVersion": "0.32.0",
    ...
    "snapshot": ".runtime/harness/3618ed978eed1706"
  },
  "event": "PreToolUse",
  "tools": {
    "Read": "read",
...
const snapshot = ".runtime/harness/3618ed978eed1706";

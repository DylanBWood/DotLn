// Origin: {"ids":["concurrent-work-requires-worktrees","contributor.executor","contributor.planner","contributor.refuter","contributor.release-close","contributor.reviewer","contributor.verifier"],"loadoutId":"contributor","semanticHash":"fnv1a64:c020dc62ca7cc8eb"}
let input, control;
try {
...
await runHarnessHook({
  ...
  "policy": {
    ...
    "policyHash": "fnv1a64:a0877ed927d35fa4"
  },
